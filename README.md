# Gloobus-Preview
# fork of: <https://bugs.launchpad.net/gloobus-preview>

## DEPENDENCES
To compile gloobus-preview you need the following dependences:

`python3, boost, gtk+ 3.0, gtksourceview 3.0, cairo, gstreamer 1.0, gst-plugins-base 1.0, poppler-glib, libspectre, djvulibre, libgxps, freetype 2, glib 2.0, libx11`
...
1. If you wrote an application and you wanna use gloobus to launch a preview, you can use it with the "gloobus-preview <filename>" option or use `org.gnome.NautilusPreviewer` D-Bus interface
